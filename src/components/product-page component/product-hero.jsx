  ...
  return (
    <div className="  w-[95%] md:w-[100%] bg-[#75FD75] h-[350px] flex flex-col md:flex-row items-center p-10 ">
      <div className=" w-[50%] p-3 flex flex-col gap-[1.5rem]">
        <p className="  text-2xl  -ml- w-[400px] md:text-[45px] text-left font-extrabold capitalize leading-tight">
      ...
      <div className=" md:w-[50%] md:h-full">
        <img
          ...
          className="mt-[-2.3rem] -ml-24 w-[26rem]"
        />
        <img
          src={nikeTagLine}
          alt="the_tagline"
          className=" w-[12rem] h-[8rem] mt-[-8rem] ml-[12rem]"
        />
      </div>
    </div>
  );
